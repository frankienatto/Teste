...
export type Page = 'home' | 'booking' | 'register' | 'login' | 'guestPortal' | 'onlineCheckin' | 'admin' | 'staffDashboard' | 'operationalDashboard' | 'forgotPassword' | 'bookingWidget' | 'usefulLinks' | 'termsAndConditions' | 'preArrivalPortal' | 'digitalMenu';
