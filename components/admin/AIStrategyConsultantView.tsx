...
import { Loader2, Sparkles, BarChart, TrendingUp, AlertTriangle, Lightbulb, Package, Truck, BrainCircuit, LineChart, Target, HelpCircle, Star, ThumbsUp, ThumbsDown, Check, X, CheckCircle, PenSquare, Zap, Globe, Search } from 'lucide-react';
